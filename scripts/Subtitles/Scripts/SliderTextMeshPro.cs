 ...
 * Un formato de texto de ejemplo que tiene que haber en este GO TestMeshPro
    ...
    no hace mucho tiempo que vívia un hidalgo; 2
...
public class SliderTextMeshPro : MonoBehaviour
{
    ...
    void GetSubtitles()
    {
        ...
        // Generaremos un array que guarde objetos de tipo Subtitle con el número de línea, texto y duración de cada línea
